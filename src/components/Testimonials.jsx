    ...
    <section id="testimonials" className="py-16 sm:py-20 bg-gradient-to-br from-zinc-950 via-zinc-900 to-zinc-950 relative overflow-hidden" aria-labelledby="testimonials-heading">
      ...
      <div className="container mx-auto px-4 sm:px-6 relative z-10">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            {/* Testimonial Card */}
            <div className="glass-card rounded-2xl p-6 sm:p-8 border border-zinc-700 hover:border-emerald-400/30 transition-all duration-500 transform hover:-translate-y-2 shadow-2xl">
            ...
            {testimonials.map((_, index) => (
              <button
                ...
                className={`w-3 h-3 sm:w-4 sm:h-4 rounded-full transition-all duration-300 ${
                  index === currentIndex ? 'bg-emerald-400 w-6 sm:w-8' : 'bg-zinc-600 hover:bg-zinc-500'
                }`}
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8 mt-12 sm:mt-20 max-w-4xl mx-auto">
            <div className="glass-card rounded-xl p-5 sm:p-6 border border-zinc-700 hover:border-emerald-400/30 transition-all duration-300 text-center transform hover:-translate-y-1">
